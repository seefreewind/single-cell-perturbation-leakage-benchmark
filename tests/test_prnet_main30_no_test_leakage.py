...
def test_prnet_main30_reports_train_only_validation_and_no_test_tuning():
...
def test_prnet_main30_split_assignment_groups_are_disjoint():
    metrics = pd.read_csv(SCI / "prnet_main30_metrics_long.csv")
...
if __name__ == "__main__":
    test_prnet_main30_reports_train_only_validation_and_no_test_tuning()
    test_prnet_main30_split_assignment_groups_are_disjoint()
