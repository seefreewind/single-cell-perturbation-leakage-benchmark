...
ROOT = Path(".")
MANUSCRIPT = ROOT / "manuscript/manuscript_full_zh_v7.md"
TABLES = ROOT / "manuscript/tables_draft_zh_v7.md"
LEGENDS = ROOT / "manuscript/figure_legends_zh_v7.md"
OUT = ROOT / "submission_package_v7/manuscript/manuscript_full_zh_v7.docx"
...
def add_table(doc: Document, key: str, rows: list[list[str]]) -> None:
    if key in {"Table 5", "Table 6", "Table 7"}:
        doc.add_page_break()
    p = doc.add_paragraph()
