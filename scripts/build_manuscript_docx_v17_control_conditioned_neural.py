#!/usr/bin/env python3
"""Build the English v17 control-conditioned neural DOCX draft."""
...
ROOT = Path(".")
MANUSCRIPT = ROOT / "manuscript/manuscript_full_en_v17_control_conditioned_neural.md"
TABLES = ROOT / "manuscript/tables_draft_en_v17_control_conditioned_neural.md"
LEGENDS = ROOT / "manuscript/figure_legends_en_v17_control_conditioned_neural.md"
OUT = ROOT / "submission_package_v17_control_conditioned_neural/manuscript/manuscript_full_en_v17_control_conditioned_neural.docx"
...
FIGURES = {
    ...
    "Fig. 3": ROOT / "figures/manuscript_main/figure4_chemical_similarity_audit.png",
    "Fig. 4": ROOT / "figures/figure6_sciplex3_prnet30_transigen30_model_panel.png",
    "Fig. 5": ROOT / "figures/figure5_pathway_level_recovery.png",
    "Fig. 6": ROOT / "figures/figure7_rank_transfer_prnet30.png",
}
...
def add_figure(doc: Document, key: str, legend: str) -> None:
    image = FIGURES[key]
    if key in {"Fig. 5", "Fig. 6"}:
        doc.add_page_break()
    p = doc.add_paragraph()
    p.alignment = WD_ALIGN_PARAGRAPH.CENTER
    width = Inches(6.9 if key in {"Fig. 4", "Fig. 5", "Fig. 6"} else 5.6)
