...
def test_prnet_main30_scaffold_and_joint_leakage_zero():
    leakage = pd.read_csv(SCI / "prnet_main30_leakage_audit.csv")
...
if __name__ == "__main__":
    test_prnet_main30_scaffold_and_joint_leakage_zero()
