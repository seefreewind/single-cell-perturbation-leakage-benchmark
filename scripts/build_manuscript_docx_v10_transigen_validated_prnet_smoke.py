#!/usr/bin/env python3
"""Build the English v10 TranSiGen-validated PRnet-smoke DOCX draft."""
...
ROOT = Path(".")
MANUSCRIPT = ROOT / "manuscript/manuscript_full_en_v10_transigen_validated_prnet_smoke.md"
TABLES = ROOT / "manuscript/tables_draft_en_v10_transigen_validated_prnet_smoke.md"
LEGENDS = ROOT / "manuscript/figure_legends_en_v10_transigen_validated_prnet_smoke.md"
OUT = ROOT / "submission_package_v10_transigen_validated_prnet_smoke/manuscript/manuscript_full_en_v10_transigen_validated_prnet_smoke.docx"
...
FIGURES = {
    ...
    "Fig. 6": ROOT / "figures/figure6_transigen_ablation_sciplex3.png",
    "Fig. 7": ROOT / "figures/figure7_rank_transfer_with_transigen.png",
    "Fig. 8": ROOT / "results/deep_model_panel/figures/figure8_foundation_embedding_feasibility.png",
}
...
def add_figure(doc: Document, key: str, legend: str) -> None:
    image = FIGURES[key]
    if key in {"Fig. 7", "Fig. 8"}:
        doc.add_page_break()
    p = doc.add_paragraph()
    p.alignment = WD_ALIGN_PARAGRAPH.CENTER
    width = Inches(6.9 if key in {"Fig. 6", "Fig. 7"} else 5.6)
