#!/usr/bin/env python3
"""Build the English v13 JGG-targeted DOCX draft."""
...
ROOT = Path(".")
MANUSCRIPT = ROOT / "manuscript/manuscript_full_en_v13_JGG_targeted_revision.md"
TABLES = ROOT / "manuscript/tables_draft_en_v13_JGG_targeted_revision.md"
LEGENDS = ROOT / "manuscript/figure_legends_en_v13_JGG_targeted_revision.md"
OUT = ROOT / "submission_package_v13_JGG_targeted_revision/manuscript/manuscript_full_en_v13_JGG_targeted_revision.docx"
...
FIGURES = {
    ...
    "Fig. 5": ROOT / "figures/figure7_rank_transfer_prnet30.png",
}
...
def add_figure(doc: Document, key: str, legend: str) -> None:
    ...
    width = Inches(6.9 if key in {"Fig. 4", "Fig. 5"} else 5.6)
