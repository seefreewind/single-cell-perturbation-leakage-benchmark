...
ROOT = Path(".")
MANUSCRIPT = ROOT / "manuscript/manuscript_full_zh_v3.md"
TABLES = ROOT / "manuscript/tables_draft_zh_v3.md"
LEGENDS = ROOT / "manuscript/figure_legends_zh_v3.md"
OUT = ROOT / "submission_package_v3/manuscript/manuscript_full_zh_v3.docx"
...
FIGURES = {
    ...
    "Fig. 5": ROOT / "figures/manuscript_main/figure5_svd_ridge_stress_test.png",
    "Fig. 6": ROOT / "figures/manuscript_main/figure6_ranking_instability.png",
}
...
def add_figure(doc: Document, key: str, legend: str) -> None:
    ...
    width = Inches(6.25 if key == "Fig. 6" else 6.7)
