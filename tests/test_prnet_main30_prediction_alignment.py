...
def test_prnet_main30_prediction_record_alignment_and_shape():
    metrics = pd.read_csv(SCI / "prnet_main30_metrics_long.csv")
    manifest = pd.read_csv(SCI / "prnet_main30_predictions_manifest.csv")
...
if __name__ == "__main__":
    test_prnet_main30_prediction_record_alignment_and_shape()
